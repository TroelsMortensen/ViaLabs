        ...
        options.toolbar.forEach(button => {
            ...
            if (button !== "|") {
                if (button.action) {
                    ...
                    } else if(button.name === ("CustomImageUpload")){
                        // button.action = EasyMDE["toggleBold"]; // index 0 for bold - test
                        button.action = EasyMDE["toggleBold"]; 
                        console.log("Custom image button")
