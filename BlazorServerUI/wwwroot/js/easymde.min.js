    ...
    return function e(t, n, r) {
        ...
        6: [function (e, t, n) {
            (function (e) {
                ...
                function i(e, n) {
                    var r = n.line, i = 0, o = 0, a = t.exec(e.getLine(r)), l = a[1];
                    do {
                        var s = r + (i += 1), u = e.getLine(s), c = t.exec(u);
                        if (c) {
                            var d = c[1], h = parseInt(a[3], 10) + i - o, f = parseInt(c[3], 10), p = f;
                            if (l !== d || isNaN(f)) {
                ...
                e.commands.newlineAndIndentContinueMarkdownList = function (o) {
                    ...
                    for (var a = o.listSelections(), l = [], s = 0; s < a.length; s++) {
                        var u = a[s].head, c = o.getStateAfter(u.line), d = e.innerMode(o.getMode(), c);
                        if ("markdown" !== d.mode.name) return void o.execCommand("newlineAndIndent");
                        var h = !1 !== (c = d.state).list, f = 0 !== c.quote, p = o.getLine(u.line), m = t.exec(p),
                            g = /^\s*$/.test(p.slice(0, u.ch));
                        if (!a[s].empty() || !h && !f || !m || g) return void o.execCommand("newlineAndIndent");
                        if (n.test(p)) {
                            var v = f && />\s*$/.test(p), x = !/>\s*$/.test(p);
                            (v || x) && o.replaceRange("", {line: u.line, ch: 0}, {
                                line: u.line,
                                ch: u.ch + 1
                            }), l[s] = "\n"
                        } else {
                            var y = m[1], b = m[5], D = !(r.test(m[2]) || m[2].indexOf(">") >= 0),
            ...
            (function (e) {
                ...
                function u(e, t, n) {
                    ...
                    for (var o = n.line, a = n.ch, l = e.firstLine(); o >= l; o--, a = -1) {
                        var u = e.getLine(o), c = s(u, t, a < 0 ? 0 : u.length - a);
                ...
                function h(e, i, o, a) {
                    ...
                    e: for (var u = o.line, c = o.ch, h = e.lastLine() + 1 - s.length; u <= h; u++, c = 0) {
                        ...
                        if (p.slice(g) == s[0]) {
                            ...
                            var x = e.getLine(u + s.length - 1), y = l(x), b = s[s.length - 1];
            ...
            (function (e) {
                ...
                function o(e, t, n, o) {
                    if (0 != i(t, n)) for (var a = e.state.markedSelection, l = e.state.markedSelectionStyle, s = t.line; ;) {
                        var u = s == t.line ? t : r(s, 0), c = s + 8, d = c >= n.line, h = d ? n : r(c, 0),
        ...
        10: [function (e, t, n) {
            !function (e, r) {
                ...
                }, j = {scroll: !1}, q = {origin: "*mouse"}, U = {origin: "+move"};
                ...
                var se = function () {
                    ...
                    return function (a, l) {
                        ...
                        for (var L = 0; L < c; ++L) if (t.test(d[L])) {
                            var M = void 0;
                            for (M = L + 1; M < c && t.test(d[M]); ++M) ;
                            for (var B = "L" == (L ? d[L - 1] : s), N = B == ("L" == (M < c ? d[M] : s)) ? B ? "L" : "R" : s, O = L; O < M; ++O) d[O] = N;
                            L = M - 1
                        }
                        for (var I, z = [], H = 0; H < c;) if (r.test(d[H])) {
                            var R = H;
                            for (++H; H < c && r.test(d[H]); ++H) ;
                            z.push(new o(0, R, H))
                        } else {
                            var P = H, _ = z.length, W = "rtl" == l ? 1 : 0;
                            for (++H; H < c && "L" != d[H]; ++H) ;
                            for (var j = P; j < H;) if (i.test(d[j])) {
                ...
                function Te(e) {
                    ...
                    var t = E(e, document.createTextNode("AخA")), n = S(t, 0, 1).getBoundingClientRect(),
                ...
                function xt(e, t, n, r) {
                    var i, o, a = e.doc, l = a.mode, s = Ge(a, (t = lt(a, t)).line), u = ft(e, t.line, n),
                        c = new $e(s.text, e.options.tabSize, u);
                    for (r && (o = []); (r || c.pos < t.ch) && !c.eol();) c.start = c.pos, i = gt(l, c, u.state), r && o.push(new vt(c, i, je(a.mode, u.state)));
                ...
                function Ft(e, t) {
                    ...
                    if (!n && !r) return null;
                    var i = t.from.ch, o = t.to.ch, a = 0 == tt(t.from, t.to), l = function (e, t, n) {
                        var r;
                    ...
                    if (!u) {
                        ...
                        if (x > 0 && l) for (var y = 0; y < l.length; ++y) null == l[y].to && (v || (v = [])).push(new wt(l[y].marker, null, null));
                ...
                function Bt(e, t) {
                    ...
                    if (0 != n) return n;
                    var r = e.find(), i = t.find(), o = tt(r.from, i.from) || Lt(e) - Lt(t);
                    if (o) return -o;
                ...
                function Ht(e, t, n, r, i) {
                    var o = Ge(e, t), a = Ct && o.markedSpans;
                    if (a) for (var l = 0; l < a.length; ++l) {
                        var s = a[l];
                        if (s.marker.collapsed) {
                            var u = s.marker.find(0), c = tt(u.from, n) || Lt(s.marker) - Lt(i),
                ...
                function jt(e, t, n) {
                    ...
                    for (var i = void 0, o = 0; o < t.markedSpans.length; ++o) if ((i = t.markedSpans[o]).marker.collapsed && !i.marker.widgetNode && i.from == n.to && (null == i.to || i.to != n.from) && (i.marker.inclusiveLeft || n.marker.inclusiveRight) && jt(e, t, i)) return !0
                }
                ...
                function Yt(e, t) {
                    var n = L("span", null, null, s ? "padding-right: .1px" : null), r = {
                ...
                function Jt(e, t, n, r, i, o, s) {
                    if (t) {
                        ...
                        if (d.test(t)) {
                            ...
                            for (var f = 0; ;) {
                                d.lastIndex = f;
                                var p = d.exec(t), m = p ? p.index - f : t.length - f;
                                if (m) {
                                ...
                                var v = void 0;
                                if ("\t" == p[0]) {
                                    var x = e.cm.options.tabSize, y = x - e.col % x;
                ...
                function nn(e, t, n) {
                    ...
                    if (r) for (var a, l, s, u, c, d, h, f = i.length, p = 0, m = 1, g = "", v = 0; ;) {
                        if (v == p) {
                            ...
                            for (var x = [], y = void 0, b = 0; b < r.length; ++b) {
                                var D = r[b], C = D.marker;
                                if ("bookmark" == C.type && D.from == p && C.widgetNode) x.push(C); else if (D.from <= p && (null == D.to || D.to > p || C.collapsed && D.to == p && D.from == p)) {
                                    if (null != D.to && D.to != p && v > D.to && (v = D.to, u = ""), C.className && (s += " " + C.className), C.css && (l = (l ? l + ";" : "") + C.css), C.startStyle && D.from == p && (c += " " + C.startStyle), C.endStyle && D.to == v && (y || (y = [])).push(C.endStyle, D.to), C.title && ((h || (h = {})).title = C.title), C.attributes) for (var w in C.attributes) (h || (h = {}))[w] = C.attributes[w];
                                    C.collapsed && (!d || Bt(d.marker, C) < 0) && (d = D)
                                } else D.from > p && v > D.from && (v = D.from)
                            }
                            if (y) for (var k = 0; k < y.length; k += 2) y[k + 1] == v && (u += " " + y[k]);
                            if (!d || d.from == p) for (var S = 0; S < x.length; ++S) tn(t, 0, x[S]);
                            if (d && (d.from || 0) == p) {
                    ...
                    } else for (var T = 1; T < n.length; T += 2) t.addToken(t, i.slice(o, o = n[T]), Zt(n[T + 1], t.cm.options))
                }
                ...
                function gn(e, t, n) {
                    ...
                    for (var r = k("CodeMirror-linewidget"), i = t.node.firstChild, o = void 0; i; i = o) o = i.nextSibling, r.test(i.className) && t.node.removeChild(i);
                    xn(e, t, n)
                }
                ...
                function Cn(e, t) {
                    for (var n = we(t); n != e.wrapper; n = n.parentNode) if (!n || 1 == n.nodeType && "true" == n.getAttribute("cm-ignore-events") || n.parentNode == e.sizer && n != e.mover) return !0
                }
                ...
                function Tn(e, t, n) {
                    ...
                    for (var i = 0; i < e.rest.length; i++) if (Ze(e.rest[i]) > n) return {
                ...
                function Bn(e, t) {
                    ...
                    r && !r.text ? r = null : r && r.changes && (cn(e, r, n, or(e)), e.curOp.forceUpdate = !0), r || (r = function (e, t) {
                        var n = Ze(t = Rt(t)), r = e.display.externalMeasured = new rn(e.doc, t, n);
                        r.lineN = n;
                ...
                function Nn(e, t, n, r, i) {
                    ...
                    return t.cache.hasOwnProperty(s) ? o = t.cache[s] : (t.rect || (t.rect = t.view.text.getBoundingClientRect()), t.hasHeights || (!function (e, t, n) {
                        var r = e.options.lineWrapping, i = r && An(e);
                        ...
                        var i, o = zn(t.map, n, r), s = o.node, u = o.start, c = o.end, d = o.collapse;
                        if (3 == s.nodeType) {
                            for (var h = 0; h < 4; h++) {
                            ...
                            a && l < 11 && (i = function (e, t) {
                                if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !function (e) {
                                    ...
                                    var t = E(e, T("span", "x")), n = t.getBoundingClientRect(),
                ...
                var On, In = {left: 0, right: 0, top: 0, bottom: 0};
                ...
                function qn(e) {
                    var t = 0;
                    if (e.widgets) for (var n = 0; n < e.widgets.length; ++n) e.widgets[n].above && (t += Dn(e.widgets[n]));
                    return t
                }
                ...
                function Vn(e, t, n, r, i, o) {
                    ...
                    var d = le(l, s, u), h = ae, f = c(s, d, "before" == u);
                ...
                function Kn(e, t) {
                    ...
                    var r = Ge(e.doc, t.line), i = qt(r) + wn(e.display);
                ...
                function Zn(e, t, n) {
                    ...
                    var i = Ye(r, n), o = r.first + r.size - 1;
                    if (i > o) return Xn(r.first + r.size - 1, Ge(r, o).text.length, null, 1, 1);
                    t < 0 && (t = 0);
                    for (var a = Ge(r, i); ;) {
                        var l = er(e, a, i, t, n), s = zt(a, l.ch + (l.xRel > 0 || l.outside > 0 ? 1 : 0));
                        if (!s) return l;
                        var u = s.find(1);
                ...
                function Yn(e, t, n, r) {
                    r -= qn(t);
                    var i = t.text.length, o = oe((function (t) {
                        return Nn(e, n, t - 1).bottom <= r
                    }), i, 0);
                    return {
                        begin: o, end: i = oe((function (t) {
                ...
                function er(e, t, n, r, i) {
                    i -= qt(t);
                    var o = Bn(e, t), a = qn(t), l = 0, s = t.text.length, u = !0, c = ue(t, e.doc.direction);
                    if (c) {
                    ...
                    if (m) {
                        var x = r - m.left < m.right - r, y = x == u;
                ...
                function tr(e, t, n, r, i, o, a) {
                    ...
                    if (l > 0) {
                        var u = 1 != s.level, c = Vn(e, et(n, u ? s.from : s.to, u ? "after" : "before"), "line", t, r);
                ...
                function rr(e) {
                    ...
                    if (null == On) {
                        ...
                        for (var t = 0; t < 49; ++t) On.appendChild(document.createTextNode("x")), On.appendChild(T("br"));
                ...
                function lr(e) {
                    var t = rr(e.display), n = e.options.lineWrapping,
                ...
                function dr(e, t, n, r) {
                    ...
                    if (r && n < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo) Ct && Pt(e.doc, t) < i.viewTo && fr(e); else if (n <= i.viewFrom) Ct && _t(e.doc, n + r) > i.viewFrom ? fr(e) : (i.viewFrom += r, i.viewTo += r); else if (t <= i.viewFrom && n >= i.viewTo) fr(e); else if (t <= i.viewFrom) {
                        ...
                        var l = pr(e, t, t, -1), s = pr(e, n, n + r, 1);
                ...
                function br(e, t, n) {
                    var r = e.display, i = e.doc, o = document.createDocumentFragment(), a = Sn(e.display), l = a.left,
                        s = Math.max(r.sizerWidth, An(e) - r.sizer.offsetLeft) - a.right, u = "ltr" == i.direction;
                    ...
                    function d(t, n, r) {
                        ...
                        function p(t, n, r) {
                            var i = Qn(e, d, null, t), o = "ltr" == n == ("after" == r) ? "left" : "right";
                        ...
                        return function (e, t, n, r) {
                            ...
                            var g = "ltr" == i, v = f(e, g ? "left" : "right"), x = f(t - 1, g ? "right" : "left"),
                                y = null == n && 0 == e, b = null == r && t == h, D = 0 == d,
                                C = !m || d == m.length - 1;
                            if (x.top - v.top <= 3) {
                                var w = (u ? b : y) && C, k = (u ? y : b) && D ? l : (g ? v : x).left,
                                    S = w ? s : (g ? x : v).right;
                    ...
                    if (h.line == f.line) d(h.line, h.ch, f.ch); else {
                        var p = Ge(i, h.line), m = Ge(i, f.line), g = Rt(p) == Rt(m),
                ...
                function Fr(e) {
                    for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
                        var i = t.view[r], o = e.options.lineWrapping, s = void 0, u = 0;
                        if (!i.hidden) {
                            if (a && l < 8) {
                            ...
                            if ((h > .005 || h < -.005) && (Xe(i.line, s), Ar(i.line), i.rest)) for (var f = 0; f < i.rest.length; f++) Ar(i.rest[f]);
                ...
                function Er(e, t, n) {
                    ...
                    r = Math.floor(r - wn(e));
                    var i = n && null != n.bottom ? n.bottom : r + e.wrapper.clientHeight, o = Ye(t, r), a = Ye(t, i);
                    if (n && n.ensure) {
                ...
                function Tr(e, t) {
                    ...
                    var l = e.doc.height + kn(n), s = t.top < r, u = t.bottom > l - r;
                    ...
                    var d = e.options.fixedGutter ? 0 : n.gutters.offsetWidth,
                        ...
                        f = An(e) - n.gutters.offsetWidth, p = t.right - t.left > f;
                ...
                function Wr(e, t) {
                    ...
                    jr(e, t);
                    for (var i = 0; i < 4 && n != e.display.barWidth || r != e.display.barHeight; i++) n != e.display.barWidth && e.options.lineWrapping && Fr(e), jr(e, Rr(e)), n = e.display.barWidth, r = e.display.barHeight
                }
                ...
                function li(e, t) {
                    for (var n = t.viewport, r = !0; ; r = !1) {
                        if (r && e.options.lineWrapping && t.oldDisplayWidth != An(e)) r && (t.visible = Er(e.display, e.doc, n)); else if (n && null != n.top && (n = {top: Math.min(e.doc.height + kn(e.display) - En(e), n.top)}), t.visible = Er(e.display, e.doc, n), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo) break;
                        if (!ai(e, t)) break;
                        Fr(e);
                        var i = Rr(e);
                ...
                function Di(e, t) {
                    var r = yi(t), i = r.x, o = r.y, a = e.display, l = a.scroller, u = l.scrollWidth > l.clientWidth,
                        c = l.scrollHeight > l.clientHeight;
                    if (i && u || o && c) {
                        if (o && x && s) e: for (var h = t.target, f = a.view; h != l; h = h.parentNode) for (var p = 0; p < f.length; p++) if (f[p].node == h) {
                        ...
                        if (o && null != xi) {
                            var m = o * xi, g = e.doc.scrollTop, v = g + a.wrapper.clientHeight;
                ...
                Ci.prototype.primary = function () {
                    ...
                    for (var e = [], t = 0; t < this.ranges.length; t++) e[t] = new wi(rt(this.ranges[t].anchor), rt(this.ranges[t].head));
                ...
                function ki(e, t, n) {
                    ...
                    for (var o = 1; o < t.length; o++) {
                        ...
                        if (r && !a.empty() ? s > 0 : s >= 0) {
                            var u = ot(l.from(), a.from()), c = it(l.to(), a.to()),
                ...
                function Ni(e, t, n, r) {
                    ...
                    function a(e, t) {
                        for (var n = [], o = e; o < t; ++o) n.push(new Gt(u[o], i(o), r));
                        return n
                    }

                    var l = t.from, s = t.to, u = t.text, c = Ge(e, l.line), d = Ge(e, s.line), h = K(u),
                        f = i(u.length - 1), p = s.line - l.line;
                    ...
                    } else if (c == d) if (1 == u.length) o(c, c.text.slice(0, l.ch) + h + c.text.slice(s.ch), f); else {
                ...
                function Ri(e, t) {
                    var n = {from: rt(t.from), to: Fi(t), text: Ve(e, t.from, t.to)};
                        ...
                        if (o.ranges) r.push(n ? Ci.prototype.deepCopy.call(o) : o); else {
                            ...
                            for (var s = 0; s < a.length; ++s) {
                                ...
                                if (l.push({
                                    ...
                                    to: u.to,
                                    text: u.text
                                }), t) for (var d in u) (c = d.match(/^spans_(\d+)$/)) && _(t, Number(c[1])) > -1 && (K(l)[d] = u[d], delete u[d])
                            }
                        }
                    }
                    return r
                ...
                function ro(e, t, n, r) {
                    for (var i, o = 0; o < t.ranges.length; o++) {
                        var a = t.ranges[o], l = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o],
                            s = oo(e, a.anchor, l && l.anchor, n, r), u = oo(e, a.head, l && l.head, n, r);
                ...
                function io(e, t, n, r, i) {
                    ...
                    if (o.markedSpans) for (var a = 0; a < o.markedSpans.length; ++a) {
                        var l = o.markedSpans[a], s = l.marker, u = "selectLeft" in s ? !s.selectLeft : s.inclusiveLeft,
                ...
                function uo(e, t, n) {
                    ...
                    if (!(ve(e, "beforeChange") || e.cm && ve(e.cm, "beforeChange")) || (t = so(e, t, !0))) {
                        var r = Dt && !n && function (e, t, n) {
                            ...
                            for (var i = [{
                                ...
                                if (!(tt(u.to, l.from) < 0 || tt(u.from, l.to) > 0)) {
                                    var c = [s, 1], d = tt(u.from, l.from), h = tt(u.to, l.to);
                        ...
                        if (r) for (var i = r.length - 1; i >= 0; --i) co(e, {
                            from: r[i].from,
                            to: r[i].to,
                            text: i ? [""] : t.text,
                            origin: t.origin
                    ...
                    if (!r || n) {
                        ...
                        if (u != l.length) {
                            for (o.lastOrigin = o.lastSelOrigin = null; ;) {
                                ...
                                if (ji(i, s), n && !i.equals(e.sel)) return void Ji(e, i, {clearRedo: !1});
                                a = i
                            }
                            var c = [];
                            ji(a, s), s.push({
                            ...
                            for (var d = ve(e, "beforeChange") || e.cm && ve(e.cm, "beforeChange"), h = function (n) {
                                ...
                                c.push(Ri(e, r));
                                var o = n ? Ei(e, r) : K(l);
                                po(e, r, o, $i(e, r)), !n && e.cm && e.cm.scrollIntoView({from: r.from, to: Fi(r)});
                                var a = [];
                                Oi(e, (function (e, t) {
                ...
                Co.prototype.clear = function () {
                    var e = this.doc.cm, t = this.line.widgets, n = this.line, r = Ze(n);
                    if (null != r && t) {
                ...
                function Fo(e, t, n, r, i) {
                    if (r && r.shared) return function (e, t, n, r, i) {
                        (r = H(r)).shared = !1;
                        var o = [Fo(e, t, n, r, i)], a = o[0], l = r.widgetNode;
                    ...
                    o.addToHistory && _i(e, {from: t, to: n, origin: "markText"}, e.sel, NaN);
                    ...
                    if (e.iter(s, n.line + 1, (function (e) {
                        ...
                        if (l && (u.curOp.updateMaxLine = !0), o.collapsed) dr(u, t.line, n.line + 1); else if (o.className || o.startStyle || o.endStyle || o.css || o.attributes || o.title) for (var c = t.line; c <= n.line; c++) hr(u, c, "text");
                ...
                So.prototype.clear = function () {
                    if (!this.explicitlyCleared) {
                        ...
                        for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                            var a = this.lines[o], l = kt(a.markedSpans, this);
                    ...
                    for (var i = 0; i < this.lines.length; ++i) {
                        var o = this.lines[i], a = kt(o.markedSpans, this);
                    ...
                    t && r && Jr(r, (function () {
                        var i = t.line, o = Ze(t.line), a = Mn(r, o);
                ...
                Mo.prototype = Y(Do.prototype, {
                    constructor: Mo, iter: function (e, t, n) {
                        ...
                        if (e.length) {
                            for (var r = [], i = 0; i < e.length; i++) r[i] = new wi(lt(this, e[i].anchor), lt(this, e[i].head || e[i].anchor));
                        ...
                        for (var l = t && "end" != t && function (e, t, n) {
                            for (var r = [], i = et(e.first, 0), o = i, a = 0; a < t.length; a++) {
                                var l = t[a], s = Ti(l.from, i, o), u = Ti(Fi(l), i, o);
                        ...
                        }(this, r, t), s = r.length - 1; s >= 0; s--) uo(this, r[s]);
                        ...
                        var t = [], n = Ge(this, (e = lt(this, e)).line).markedSpans;
                ...
                function No(e) {
                    ...
                    if (Oo(t), !me(t, e) && !Cn(t.display, e)) {
                        ...
                        if (n && !t.isReadOnly()) if (r && r.length && window.FileReader && window.File) for (var i = r.length, o = Array(i), l = 0, s = function () {
                            ++l == i && ei(t, (function () {
                                var e = {
                                    from: n = lt(t.doc, n), to: n, text: t.doc.splitLines(o.filter((function (e) {
                                        return null != e
                            ...
                            try {
                                ...
                                if (d) {
                                    var h;
                                    if (t.state.draggingText && !t.state.draggingText.copy && (h = t.listSelections()), eo(t.doc, Si(n, n)), h) for (var f = 0; f < h.length; ++f) mo(t.doc, "", h[f].anchor, h[f].head, "drag");
                ...
                for (var Po = {
                    ...
                    63277: "PageDown",
                    63302: "Insert"
                }, _o = 0; _o < 10; _o++) Po[_o + 48] = Po[_o + 96] = String(_o);
                ...
                var ta = {
                    selectAll: lo, singleSelection: function (e) {
                        ...
                        return Yo(e, (function (t) {
                            return {from: et(t.from().line, 0), to: lt(e.doc, et(t.to().line + 1, 0))}
                        }))
                        ...
                        for (var t = [], n = e.listSelections(), r = e.options.tabSize, i = 0; i < n.length; i++) {
                            var o = n[i].from(), a = R(e.getLine(o.line), o.ch, r);
                            t.push(V(r - a % r))
                        }
                        ...
                        return Jr(e, (function () {
                            for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++) if (t[r].empty()) {
                                var i = t[r].head, o = Ge(e.doc, i.line).text;
                ...
                function na(e, t) {
                    var n = Ge(e.doc, t), r = Rt(n);
                    return r != n && (t = Ze(r)), ea(!0, e, r, t, 1)
                }

                function ra(e, t) {
                    var n = na(e, t.line), r = Ge(e.doc, n.line), i = ue(r, e.doc.direction);
                    if (!i || 0 == i[0].level) {
                ...
                function ga(e) {
                    ...
                    if (!(me(t, e) || n.activeTouch && n.input.supportsTouch())) if (n.input.ensurePolled(), n.shift = e.shiftKey, Cn(n, e)) s || (n.scroller.draggable = !1, setTimeout((function () {
                        ...
                        var r = ur(t, e), i = ke(e), o = r ? function (e, t) {
                            var n = +new Date;
                        ...
                        window.focus(), 1 == i && t.state.selectingText && t.state.selectingText(e), r && function (e, t, n, r, i) {
                            ...
                            e.options.dragDrop && Ae && !e.isReadOnly() && "single" == n && (i = u.contains(t)) > -1 && (tt((i = u.ranges[i]).from(), t) < 0 || t.xRel > 0) && (tt(i.to(), t) > 0 || t.xRel < 0) ? function (e, t, n, r) {
                                var i = e.display, o = !1, u = ei(e, (function (t) {
                                ...
                                function f(t) {
                                    if (0 != tt(h, t)) if (h = t, "rectangle" == r.unit) {
                                        ...
                                        w[s] = function (e, t) {
                                            ...
                                            var h = o[u + (s ? -1 : 0)], f = s == (1 == h.level), p = f ? h.from : h.to,
                                                m = f ? "after" : "before";
                                ...
                                var p = i.wrapper.getBoundingClientRect(), m = 0;

                                function g(t) {
                                    var n = ++m, a = ur(e, t, !0, "rectangle" == r.unit);
                                    if (a) if (0 != tt(a, h)) {
                                        e.curOp.focus = B(), f(a);
                                        var l = Er(i, o);
                ...
                function Aa(e, t) {
                    ...
                    var i = new Aa.inputStyles[t.inputStyle](this), o = this.display = new gi(e, r, i, t);
                    ...
                    }), 20) : Sr(this), ka) ka.hasOwnProperty(u) && ka[u](this, t[u], Ca);
                ...
                function Ta(e, t, n, r) {
                    ...
                    var a = e.options.tabSize, l = Ge(o, t), s = R(l.text, null, a);
                ...
                function Ba(e, t, n, r, i) {
                    ...
                    var a = +new Date - 200, l = "paste" == i || e.state.pasteIncoming > a, s = Me(t), u = null;
                    ...
                    for (var d = e.curOp.updateInput, h = r.ranges.length - 1; h >= 0; h--) {
                        var f = r.ranges[h], p = f.from(), m = f.to();
                ...
                function Ra(e, t, n, r, i) {
                    var o = t, a = n, l = Ge(e, t.line), s = i && "rtl" == e.direction ? -n : n;
                    ...
                    function u(o) {
                        ...
                        if ("codepoint" == r) {
                            ...
                            if ("rtl" == e.doc.direction || 1 == a.level) {
                                var d = 1 == a.level == r < 0, h = s(n, d ? 1 : -1);
                ...
                function Wa(e, t) {
                    ...
                    var r = Ge(e.doc, t.line), i = Tn(n, r, t.line), o = ue(r, e.doc.direction), a = "left";
                ...
                function Ua(e, t, n) {
                    ...
                    function c(t, n, r) {
                        for (var i = -1; i < (u ? u.length : 0); i++) for (var o = i < 0 ? s.map : u[i], a = 0; a < o.length; a += 3) {
                            var l = o[a + 2];
                            if (l == t || l == n) {
                                var c = Ze(i < 0 ? e.line : e.rest[i]), d = o[a] + r;
                ...
                _a.prototype.init = function (e) {
                    ...
                    function a(e) {
                        if (o(e) && !me(r, e)) {
                            if (r.somethingSelected()) Ma({
                                ...
                                var t = Ia(r);
                                Ma({lineWise: !0, text: t.text}), "cut" == e.type && r.operation((function () {
                    ...
                    if (t.display.viewTo == t.display.viewFrom || i.line >= t.display.viewTo || o.line < t.display.viewFrom) e.removeAllRanges(); else {
                        var a = qa(t, e.anchorNode, e.anchorOffset), l = qa(t, e.focusNode, e.focusOffset);
                        if (!a || a.bad || !l || l.bad || 0 != tt(ot(a, l), i) || 0 != tt(it(a, l), o)) {
                            var s = t.display.view,
                                u = i.line >= t.display.viewFrom && Wa(t, i) || {node: s[0].measure.map[2], offset: 0},
                                c = o.line < t.display.viewTo && Wa(t, o);
                            if (!c) {
                                var d = s[s.length - 1].measure, h = d.maps ? d.maps[d.maps.length - 1] : d.map;
                    ...
                    for (var d = r.doc.splitLines(function (e, t, n, r, i) {
                        ...
                        return o
                    }(r, n, u, t, s)), h = Ve(r.doc, et(t, 0), et(s, Ge(r.doc, s).text.length)); d.length > 1 && h.length > 1;) if (K(d) == K(h)) d.pop(), h.pop(), s--; else {
                        if (d[0] != h[0]) break;
                        d.shift(), h.shift(), t++
                    }
                    ...
                    var D = et(t, f), C = et(s, h.length ? K(h).length - p : 0);
                ...
                $a.prototype.init = function (e) {
                    ...
                    function o(e) {
                        if (!me(r, e)) {
                            if (r.somethingSelected()) Ma({lineWise: !1, text: r.getSelections()}); else {
                                if (!r.options.lineWiseCopyCut) return;
                                var t = Ia(r);
                                Ma({
                                    lineWise: !0,
                    ...
                    var e = this.cm, t = e.display, n = e.doc, r = vr(e);
                    ...
                    if (o && !d) {
                        ...
                        var c, h = i.style.cssText, f = t.wrapper.style.cssText,
                ...
                }, $a.prototype.needsContentAttribute = !1, function (e) {
                    ...
                    e.prototype = {
                        ...
                        findWordAt: function (e) {
                            var t = Ge(this.doc, e.line).text, n = e.ch, r = e.ch;
                            if (t) {
                ...
                for (var Va in Mo.prototype) Mo.prototype.hasOwnProperty(Va) && _(Ga, Va) < 0 && (Aa.prototype[Va] = function (e) {
                    return function () {
                        return e.apply(this.doc, arguments)
                    }
                }(Mo.prototype[Va]));
                return xe(Mo), Aa.inputStyles = {textarea: $a, contenteditable: _a}, Aa.defineMode = function (e) {
        ...
        12: [function (e, t, n) {
            ...
            r = function (e) {
                ...
                e.defineMode("markdown", (function (t, n) {
                    ...
                    var l = /^([*\-_])(?:\s*\1){2,}\s*$/, s = /^(?:[*\-+]|^[0-9]+([.)]))\s+/, u = /^\[(x| )\](?=\s)/i,
                        c = n.allowAtxHeaderWithoutSpace ? /^(#+)/ : /^(#+)(?: |$)/, d = /^ {0,3}(?:\={1,}|-{2,})\s*$/,
                        h = /^[^#!\[\]*_\\<>` "'(~:]+/, f = /^(~~~+|```+)[ \t]*([\w\/+#-]*)[^\n`]*$/,
                        p = /^\s*\[[^\]]+?\]:.*$/,
                    ...
                    function y(r, i) {
                        var a, h = r.column() === i.indentation, m = !(a = i.prevLine.stream) || !/\S/.test(a.string),
                            v = i.indentedCode, x = i.prevLine.hr, y = !1 !== i.list,
                            b = (i.listStack[i.listStack.length - 1] || 0) + 3;
                        i.indentedCode = !1;
                        var w = i.indentation;
                        if (null === i.indentationDiff && (i.indentationDiff = i.indentation, y)) {
                            for (i.list = null; w < i.listStack[i.listStack.length - 1];) i.listStack.pop(), i.listStack.length ? i.indentation = i.listStack[i.listStack.length - 1] : i.list = !1;
                            !1 !== i.list && (i.indentationDiff = w - i.listStack[i.listStack.length - 1])
                        }
                        var k = !(m || x || i.prevLine.header || y && v || i.prevLine.fencedCodeEnd),
                            S = (!1 === i.list || x || m) && i.indentation <= b && r.match(l), F = null;
                    ...
                    function k(t, i) {
                        ...
                        if ("\\" === l && (t.next(), n.highlightFormatting)) {
                            var p = C(i), g = o.formatting + "-escape";
                            return p ? p + " " + g : g
                        }
                        ...
                        if ("*" === l || "_" === l) {
                            ...
                            var A = t.peek() || " ", E = !/\s/.test(A) && (!m.test(A) || /\s/.test(w) || m.test(w)),
                                T = !/\s/.test(w) && (!m.test(w) || /\s/.test(A) || m.test(A)), L = null, M = null;
                    ...
                    var M = {
                        ...
                        innerMode: function (e) {
                            return e.block == b ? {state: e.htmlState, mode: r} : e.localState ? {
                                state: e.localState,
                                mode: e.localMode
                            } : {state: e, mode: M}
                        },
        ...
        15: [function (e, t, n) {
            !function (e, r) {
                ...
                var D = function (e, t) {
                    ...
                    return n + e
                }, B = r.defaults, N = E, O = A, I = D, z = T;

                function H(e, t, n) {
                    var r = t.href, i = t.title ? I(t.title) : null, o = e[1].replace(/\\([\[\]])/g, "$1");
                ...
                var R = function () {
                    ...
                    return t.space = function (e) {
                        ...
                        if (t) {
                            var n, r, i, o, a, l, s, u, c, d = t[0], h = t[2], f = h.length > 1, p = {
                                type: "list",
                                raw: d,
                                ordered: f,
                                start: f ? +h.slice(0, -1) : "",
                                loose: !1,
                                items: []
                            }, m = t[0].match(this.rules.block.item), g = !1, v = m.length;
                        ...
                        if (r && (!r[3] || !n.match(/(?:[0-9A-Za-z\xAA\xB2\xB3\xB5\xB9\xBA\xBC-\xBE\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u0660-\u0669\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07C0-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u08A0-\u08B4\u08B6-\u08C7\u0904-\u0939\u093D\u0950\u0958-\u0961\u0966-\u096F\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09E6-\u09F1\u09F4-\u09F9\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A66-\u0A6F\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AE6-\u0AEF\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B66-\u0B6F\u0B71-\u0B77\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0BE6-\u0BF2\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C60\u0C61\u0C66-\u0C6F\u0C78-\u0C7E\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDE\u0CE0\u0CE1\u0CE6-\u0CEF\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D58-\u0D61\u0D66-\u0D78\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0DE6-\u0DEF\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E50-\u0E59\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0ED0-\u0ED9\u0EDC-\u0EDF\u0F00\u0F20-\u0F33\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F-\u1049\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u1090-\u1099\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1369-\u137C\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16EE-\u16F8\u1700-\u170C\u170E-\u1711\u1720-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u17E0-\u17E9\u17F0-\u17F9\u1810-\u1819\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1946-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u19D0-\u19DA\u1A00-\u1A16\u1A20-\u1A54\u1A80-\u1A89\u1A90-\u1A99\u1AA7\u1B05-\u1B33\u1B45-\u1B4B\u1B50-\u1B59\u1B83-\u1BA0\u1BAE-\u1BE5\u1C00-\u1C23\u1C40-\u1C49\u1C4D-\u1C7D\u1C80-\u1C88\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2070\u2071\u2074-\u2079\u207F-\u2089\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2150-\u2189\u2460-\u249B\u24EA-\u24FF\u2776-\u2793\u2C00-\u2C2E\u2C30-\u2C5E\u2C60-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2CFD\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005-\u3007\u3021-\u3029\u3031-\u3035\u3038-\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u3192-\u3195\u31A0-\u31BF\u31F0-\u31FF\u3220-\u3229\u3248-\u324F\u3251-\u325F\u3280-\u3289\u32B1-\u32BF\u3400-\u4DBF\u4E00-\u9FFC\uA000-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6EF\uA717-\uA71F\uA722-\uA788\uA78B-\uA7BF\uA7C2-\uA7CA\uA7F5-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA830-\uA835\uA840-\uA873\uA882-\uA8B3\uA8D0-\uA8D9\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA900-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF-\uA9D9\uA9E0-\uA9E4\uA9E6-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA50-\uAA59\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uABF0-\uABF9\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF10-\uFF19\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDD07-\uDD33\uDD40-\uDD78\uDD8A\uDD8B\uDE80-\uDE9C\uDEA0-\uDED0\uDEE1-\uDEFB\uDF00-\uDF23\uDF2D-\uDF4A\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF\uDFD1-\uDFD5]|\uD801[\uDC00-\uDC9D\uDCA0-\uDCA9\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC58-\uDC76\uDC79-\uDC9E\uDCA7-\uDCAF\uDCE0-\uDCF2\uDCF4\uDCF5\uDCFB-\uDD1B\uDD20-\uDD39\uDD80-\uDDB7\uDDBC-\uDDCF\uDDD2-\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE40-\uDE48\uDE60-\uDE7E\uDE80-\uDE9F\uDEC0-\uDEC7\uDEC9-\uDEE4\uDEEB-\uDEEF\uDF00-\uDF35\uDF40-\uDF55\uDF58-\uDF72\uDF78-\uDF91\uDFA9-\uDFAF]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDCFA-\uDD23\uDD30-\uDD39\uDE60-\uDE7E\uDE80-\uDEA9\uDEB0\uDEB1\uDF00-\uDF27\uDF30-\uDF45\uDF51-\uDF54\uDFB0-\uDFCB\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC52-\uDC6F\uDC83-\uDCAF\uDCD0-\uDCE8\uDCF0-\uDCF9\uDD03-\uDD26\uDD36-\uDD3F\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDD0-\uDDDA\uDDDC\uDDE1-\uDDF4\uDE00-\uDE11\uDE13-\uDE2B\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDEF0-\uDEF9\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC50-\uDC59\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDCD0-\uDCD9\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE50-\uDE59\uDE80-\uDEAA\uDEB8\uDEC0-\uDEC9\uDF00-\uDF1A\uDF30-\uDF3B]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCF2\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDD50-\uDD59\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEC0-\uDEF8]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC50-\uDC6C\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD50-\uDD59\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDA0-\uDDA9\uDEE0-\uDEF2\uDFB0\uDFC0-\uDFD4]|\uD808[\uDC00-\uDF99]|\uD809[\uDC00-\uDC6E\uDC80-\uDD43]|[\uD80C\uD81C-\uD820\uD822\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879\uD880-\uD883][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2E]|\uD811[\uDC00-\uDE46]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE60-\uDE69\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF50-\uDF59\uDF5B-\uDF61\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDE40-\uDE96\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3]|\uD821[\uDC00-\uDFF7]|\uD823[\uDC00-\uDCD5\uDD00-\uDD08]|\uD82C[\uDC00-\uDD1E\uDD50-\uDD52\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD834[\uDEE0-\uDEF3\uDF60-\uDF78]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB\uDFCE-\uDFFF]|\uD838[\uDD00-\uDD2C\uDD37-\uDD3D\uDD40-\uDD49\uDD4E\uDEC0-\uDEEB\uDEF0-\uDEF9]|\uD83A[\uDC00-\uDCC4\uDCC7-\uDCCF\uDD00-\uDD43\uDD4B\uDD50-\uDD59]|\uD83B[\uDC71-\uDCAB\uDCAD-\uDCAF\uDCB1-\uDCB4\uDD01-\uDD2D\uDD2F-\uDD3D\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD83C[\uDD00-\uDD0C]|\uD83E[\uDFF0-\uDFF9]|\uD869[\uDC00-\uDEDD\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF34\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A])/))) {
                            ...
                            if (!i || i && ("" === n || this.rules.inline.punctuation.exec(n))) {
                                var o, a, l = r[0].length - 1, s = l, u = 0,
                                    c = "*" === r[0][0] ? this.rules.inline.emStrong.rDelimAst : this.rules.inline.emStrong.rDelimUnd;
                                for (c.lastIndex = 0, t = t.slice(-1 * e.length + l); null != (r = c.exec(t));) if (o = r[1] || r[2] || r[3] || r[4] || r[5] || r[6]) if (a = o.length, r[3] || r[4]) s += a; else if (!((r[5] || r[6]) && l % 3) || (l + a) % 3) {
                                    if (!((s -= a) > 0)) {
                ...
                var U = {block: j, inline: q}, $ = r.defaults, G = U.block, V = U.inline, K = M;
                ...
                var Y = function () {
                    ...
                    return o.lex = function (e) {
                        ...
                        var r, i, o, a;
                        for (void 0 === t && (t = []), void 0 === n && (n = !0), this.options.pedantic && (e = e.replace(/^ +$/gm, "")); e;) if (r = this.tokenizer.space(e)) e = e.substring(r.raw.length), r.type && t.push(r); else if (r = this.tokenizer.code(e)) e = e.substring(r.raw.length), (a = t[t.length - 1]) && "paragraph" === a.type ? (a.raw += "\n" + r.raw, a.text += "\n" + r.text) : t.push(r); else if (r = this.tokenizer.fences(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.heading(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.nptable(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.hr(e)) e = e.substring(r.raw.length), t.push(r); else if (r = this.tokenizer.blockquote(e)) e = e.substring(r.raw.length), r.tokens = this.blockTokens(r.text, [], n), t.push(r); else if (r = this.tokenizer.list(e)) {
                        ...
                        if (this.tokens.links) {
                            ...
                            if (c.length > 0) for (; null != (a = this.tokenizer.rules.inline.reflinkSearch.exec(u));) c.includes(a[0].slice(a[0].lastIndexOf("[") + 1, -1)) && (u = u.slice(0, a.index) + "[" + K("a", a[0].length - 2) + "]" + u.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
                        }
                        for (; null != (a = this.tokenizer.rules.inline.blockSkip.exec(u));) u = u.slice(0, a.index) + "[" + K("a", a[0].length - 2) + "]" + u.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
                        ...
                        for (; e;) if (l || (s = ""), l = !1, i = this.tokenizer.escape(e)) e = e.substring(i.raw.length), t.push(i); else if (i = this.tokenizer.tag(e, n, r)) {
                ...
                }(), Q = r.defaults, J = k, ee = D, te = function () {
                    function e(e) {
                        this.options = e || Q
                    }
                ...
                }(), ie = r.defaults, oe = C, ae = function () {
                    function e(e) {
                    ...
                    return t.parse = function (e, t) {
                        void 0 === t && (t = !0);
                        var n, r, i, o, a, l, s, u, c, d, h, f, p, m, g, v, x, y, b = "", D = e.length;
                        for (n = 0; n < D; n++) switch ((d = e[n]).type) {
                            case "space":
                                continue;
                            case "hr":
                                b += this.renderer.hr();
                            ...
                            case "code":
                                ...
                                continue;
                            case "table":
                                for (u = "", s = "", o = d.header.length, r = 0; r < o; r++) s += this.renderer.tablecell(this.parseInline(d.tokens.header[r]), {
                                    header: !0,
                                    align: d.align[r]
                                });
                            ...
                            case "paragraph":
                                ...
                                continue;
                            case "text":
                                for (c = d.tokens ? this.parseInline(d.tokens) : d.text; n + 1 < D && "text" === e[n + 1].type;) c += "\n" + ((d = e[++n]).tokens ? this.parseInline(d.tokens) : d.text);
                ...
                }(), le = F, se = L, ue = D, ce = r.getDefaults, de = r.changeDefaults, he = r.defaults;
                ...
                return fe.options = fe.setOptions = function (e) {
                    ...
                    if (e.renderer && function () {
                        var n = fe.defaults.renderer || new te, r = function (t) {
                            var r = n[t];
                            n[t] = function () {
                        ...
                        var n = fe.defaults.tokenizer || new R, r = function (t) {
                            var r = n[t];
                            n[t] = function () {
                                for (var i = arguments.length, o = new Array(i), a = 0; a < i; a++) o[a] = arguments[a];
                    ...
                    for (var r, i = n(e); !(r = i()).done;) {
                        ...
                        switch (t(o), o.type) {
                            case "table":
                                ...
                                for (var u, c = n(o.tokens.cells); !(u = c()).done;) for (var d, h = n(u.value); !(d = h()).done;) {
                                    var f = d.value;
                                    fe.walkTokens(f, t)
                                }
                                break;
                    ...
                    !function () {
                        ...
                        (r = function (e, t, r, i) {
                            ...
                            function p() {
                                ...
                                for (a in "ONLYINCOMPOUND" in c.flags && (c.compoundRuleCodes[c.flags.ONLYINCOMPOUND] = []), c.dictionaryTable = c._parseDIC(r), c.compoundRuleCodes) 0 === c.compoundRuleCodes[a].length && delete c.compoundRuleCodes[a];
                                for (a = 0, s = c.compoundRules.length; a < s; a++) {
                                    var n = c.compoundRules[a], o = "";
                            ...
                            load: function (e) {
                                ...
                                for (i = 0, a = u.length; i < a; i++) {
                                    var c = (t = u[i]).split(/\s+/), d = c[0];
                                    if ("PFX" == d || "SFX" == d) {
                                        var h = c[1], f = c[2], p = [];
                                        for (o = i + 1, l = i + 1 + (n = parseInt(c[3], 10)); o < l; o++) {
                                            var m = (r = u[o].split(/\s+/))[2], g = r[3].split("/"), v = g[0];
                                            "0" === v && (v = "");
                                            var x = this.parseRuleCodes(g[1]), y = r[4], b = {};
                                        ...
                                        s[h] = {type: d, combineable: "Y" == f, entries: p}, i += n
                                    } else if ("COMPOUNDRULE" === d) {
                                        for (o = i + 1, l = i + 1 + (n = parseInt(c[1], 10)); o < l; o++) r = (t = u[o]).split(/\s+/), this.compoundRules.push(r[1]);
                                        i += n
                                ...
                                function s(e, t) {
                                    var n, r, i, o, a = {}, s = l.alphabet.length;
                                    if ("string" == typeof e) {
                                        var u = e;
                                        (e = {})[u] = !0
                                    }
                                    for (var u in e) for (n = 0, i = u.length + 1; n < i; n++) {
        ...
        18: [function (e, t, n) {
            ...
            var i = e("codemirror-spell-checker"), o = e("marked/lib/marked"), a = /Mac/.test(navigator.platform),
                l = new RegExp(/(<a.*?https?:\/\/.*?[^a]>)+?/g), s = {
                    toggleBold: C,
                    toggleItalic: w,
                    drawLink: I,
            ...
            function D(e) {
                ...
                var n = t.getWrapperElement(), r = n.nextSibling;
            ...
            function S(e) {
                ...
                var o, a, l, s = e.codemirror, u = s.getCursor("start"), c = s.getCursor("end"),
                    d = s.getTokenAt({line: u.line, ch: u.ch || 1}), h = s.getLineHandle(u.line),
                    f = i(s, u.line, h, d);
                if ("single" === f) {
                    var p = h.text.slice(0, u.ch).replace("`", ""), m = h.text.slice(u.ch).replace("`", "");
                    s.replaceRange(p + m, {line: u.line, ch: 0}, {
                        line: u.line,
                        ch: 99999999999999
                    }), u.ch--, u !== c && c.ch--, s.setSelection(u, c), s.focus()
                } else if ("fenced" === f) if (u.line !== c.line || u.ch !== c.ch) {
                    for (o = u.line; o >= 0 && !n(h = s.getLineHandle(o)); o--) ;
                    var g, v, x, y, b = r(s.getTokenAt({line: o, ch: 1})).fencedChars;
                    n(s.getLineHandle(u.line)) ? (g = "", v = u.line) : n(s.getLineHandle(u.line - 1)) ? (g = "", v = u.line - 1) : (g = b + "\n", v = u.line), n(s.getLineHandle(c.line)) ? (x = "", y = c.line, 0 === c.ch && (y += 1)) : 0 !== c.ch && n(s.getLineHandle(c.line + 1)) ? (x = "", y = c.line + 1) : (x = b + "\n", y = c.line + 1), 0 === c.ch && (y -= 1), s.operation((function () {
                        s.replaceRange(x, {line: y, ch: 0}, {line: y + (x ? 0 : 1), ch: 0}), s.replaceRange(g, {
                            line: v,
                            ch: 0
                        }, {line: v + (g ? 0 : 1), ch: 0})
                    })), s.setSelection({line: v + (g ? 1 : 0), ch: 0}, {line: y + (g ? 1 : -1), ch: 0}), s.focus()
                } else {
                    var D = u.line;
                    ...
                    s.operation((function () {
                        s.replaceRange("", {line: o, ch: 0}, {line: o + 1, ch: 0}), s.replaceRange("", {
                            line: a - 1,
                            ch: 0
                        }, {line: a, ch: 0})
                    })), s.focus()
                    ...
                    if (u.line !== c.line || u.ch !== c.ch) o = u.line, a = c.line, 0 === c.ch && a--; else {
                        for (o = u.line; o >= 0; o--) if (!(h = s.getLineHandle(o)).text.match(/^\s*$/) && "indented" !== i(s, o, h)) {
                            o += 1;
                            break
                        }
                        for (l = s.lineCount(), a = u.line; a < l; a++) if (!(h = s.getLineHandle(a)).text.match(/^\s*$/) && "indented" !== i(s, a, h)) {
                            a -= 1;
                            break
                        }
                    }
                    var C = s.getLineHandle(a + 1), w = C && s.getTokenAt({line: a + 1, ch: C.text.length - 1});
                    w && r(w).indentedCode && s.replaceRange("\n", {line: a + 1, ch: 0});
                    for (var k = o; k <= a; k++) s.indentLine(k, "subtract");
                    s.focus()
                } else {
                    var S = u.line === c.line && u.ch === c.ch && 0 === u.ch, F = u.line !== c.line;
            ...
            function I(e) {
                var t = e.codemirror, n = y(t), r = e.options, i = "https://";
            ...
            function R(e, t) {
                var n = e.codemirror, r = y(n), i = e.options, o = t.substr(t.lastIndexOf("/") + 1),
            ...
            function P(e) {
                var t = e.codemirror, n = y(t), r = e.options;
            ...
            function q(e) {
                var t = e.codemirror, n = t.getWrapperElement(), r = n.nextSibling,
                    i = e.toolbarElements && e.toolbarElements["side-by-side"], o = !1, a = n.parentNode;
                ...
                if (/editor-preview-active/.test(l.className)) {
                    ...
                    var s = e.toolbarElements.preview, u = e.toolbar_div;
            ...
            function U(e) {
                var t = e.codemirror, n = t.getWrapperElement(), r = e.toolbar_div,
                ...
                if (/editor-preview-active-side/.test(a.className) && q(e), !o || !/editor-preview-full/.test(o.className)) {
                    if ((o = document.createElement("div")).className = "editor-preview-full", e.options.previewClass) if (Array.isArray(e.options.previewClass)) for (var l = 0; l < e.options.previewClass.length; l++) o.className += " " + e.options.previewClass[l]; else "string" == typeof e.options.previewClass && (o.className += " " + e.options.previewClass);
                    n.appendChild(o)
                }
            ...
            function K(e, t, n, r) {
                if (!/editor-preview-active/.test(e.codemirror.getWrapperElement().lastChild.className)) {
                    r = void 0 === r ? n : r;
                    var i, o = e.codemirror, a = y(o), l = n, s = r, u = o.getCursor("start"), c = o.getCursor("end");
            ...
            function Z(e, t) {
                for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (t[n] instanceof Array ? e[n] = t[n].concat(e[n] instanceof Array ? e[n] : []) : null !== t[n] && "object" == typeof t[n] && t[n].constructor === Object ? e[n] = Z(e[n] || {}, t[n]) : e[n] = t[n]);
                return e
            }
            ...
            var J = {
                    ...
                    italic: {name: "italic", action: w, className: "fa fa-italic", title: "Italic", default: !0},
                    strikethrough: {
                        name: "strikethrough",
                        action: k,
                    ...
                    code: {name: "code", action: S, className: "fa fa-code", title: "Code"},
                    ...
                    "clean-block": {name: "clean-block", action: O, className: "fa fa-eraser", title: "Clean block"},
                    "separator-2": {name: "separator-2"},
                    link: {name: "link", action: I, className: "fa fa-link", title: "Create Link", default: !0},
                    image: {name: "image", action: z, className: "fa fa-image", title: "Insert Image", default: !0},
                    "upload-image": {name: "upload-image", action: H, className: "fa fa-image", title: "Import an image"},
                    ...
                    undo: {name: "undo", action: W, className: "fa fa-undo", noDisable: !0, title: "Undo"},
                    redo: {name: "redo", action: j, className: "fa fa-repeat fa-redo", noDisable: !0, title: "Redo"}
                }, ee = {
                    link: ["[", "](#url#)"],
                    image: ["![](", "#url#)"],
                    uploadedImage: ["![](#url#)", ""],
            ...
            function ae(e) {
                ...
                if (void 0 === e.toolbar) for (var o in e.toolbar = [], J) Object.prototype.hasOwnProperty.call(J, o) && (-1 != o.indexOf("separator-") && e.toolbar.push("|"), (!0 === J[o].default || e.showIcons && e.showIcons.constructor === Array && -1 != e.showIcons.indexOf(o)) && e.toolbar.push(o));
                ...
                }), e.parsingConfig = Y({highlightFormatting: !0}, e.parsingConfig || {}), e.insertTexts = Y({}, ee, e.insertTexts || {}), e.promptTexts = Y({}, te, e.promptTexts || {}), e.blockStyles = Y({}, re, e.blockStyles || {}), null != e.autosave && (e.autosave.timeFormat = Y({}, ne, e.autosave.timeFormat || {})), e.shortcuts = Y({}, u, e.shortcuts || {}), e.maxHeight = e.maxHeight || void 0, void 0 !== e.maxHeight ? e.minHeight = e.maxHeight : e.minHeight = e.minHeight || "300px", e.errorCallback = e.errorCallback || function (e) {
                    alert(e)
            ...
            ae.prototype.uploadImages = function (e, t, n) {
                ...
                if (o) {
                    ...
                    return this.options.renderingConfig && "function" == typeof this.options.renderingConfig.sanitizerFunction && (r = this.options.renderingConfig.sanitizerFunction.call(this, r)), r = function (e) {
                        for (var t = (new DOMParser).parseFromString(e, "text/html"), n = t.getElementsByTagName("li"), r = 0; r < n.length; r++) for (var i = n[r], o = 0; o < i.children.length; o++) {
                            var a = i.children[o];
                ...
                if (e || (e = this.element || document.getElementsByTagName("textarea")[0]), !this._rendered || this._rendered !== e) {
                    ...
                    })), t = "overlay-mode", (n = o.parsingConfig).gitHubSpice = !1) : ((t = o.parsingConfig).name = "gfm", t.gitHubSpice = !1), !1 !== o.spellChecker && (t = "spell-checker", (n = o.parsingConfig).name = "gfm", n.gitHubSpice = !1, i({codeMirrorInstance: r})), this.codemirror = r.fromTextArea(e, {
                        mode: t,
                        backdrop: n,
                ...
                var n = this, r = this.gui.toolbar.getElementsByClassName("imageInput")[0];
                ...
                var e = this.codemirror.getWrapperElement(), t = e.nextSibling,
                ...
                if (!n || !/editor-preview-side/.test(n.className)) {
                    if ((n = document.createElement("div")).className = "editor-preview-side", this.options.previewClass) if (Array.isArray(this.options.previewClass)) for (var r = 0; r < this.options.previewClass.length; r++) n.className += " " + this.options.previewClass[r]; else "string" == typeof this.options.previewClass && (n.className += " " + this.options.previewClass);
                ...
                return e.on("scroll", (function (e) {
                    if (i) i = !1; else {
                        ...
                        var t = e.getScrollInfo().height - e.getScrollInfo().clientHeight,
                            r = parseFloat(e.getScrollInfo().top) / t, a = (n.scrollHeight - n.clientHeight) * r;
                        n.scrollTop = a
                    }
                })), n.onscroll = function () {
                    if (o) o = !1; else {
                        i = !0;
                        var t = n.scrollHeight - n.clientHeight, r = parseFloat(n.scrollTop) / t,
                ...
                if ((e = e || this.options.toolbar) && 0 !== e.length) {
                    var t;
                    for (t = 0; t < e.length; t++) null != J[e[t]] && (e[t] = J[e[t]]);
                    var n = document.createElement("div");
                    n.className = "editor-toolbar";
                    var r = this, i = {};
                    for (r.toolbar = e, t = 0; t < e.length; t++) if (("guide" != e[t].name || !1 !== r.options.toolbarGuideIcon) && !(r.options.hideIcons && -1 != r.options.hideIcons.indexOf(e[t].name) || ("fullscreen" == e[t].name || "side-by-side" == e[t].name) && c())) {
                        if ("|" === e[t]) {
                ...
                if (e && 0 !== e.length) {
                    var r, i, o, a, l = [];
                    for (r = 0; r < e.length; r++) if (i = void 0, o = void 0, a = void 0, "object" == typeof e[r]) l.push({
                        ...
                        }), l.push({className: s, defaultValue: a, onUpdate: i, onActivity: o})
                    }
                    var u = document.createElement("div");
                    for (u.className = "editor-statusbar", r = 0; r < l.length; r++) {
                        var c = l[r], d = document.createElement("span");
                ...
                var e = this.codemirror, t = e.getWrapperElement(), n = t.parentNode;
